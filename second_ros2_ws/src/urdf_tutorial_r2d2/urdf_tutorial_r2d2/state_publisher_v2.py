...
class StatePublisher(Node):
    ...
    def __init__(self):
        ...
        super().__init__('state_publisher_v2')

        qos_profile = QoSProfile(depth=10)
        self.joint_pub = self.create_publisher(JointState, 'joint_states', qos_profile)
        # subscriptions
        self.create_subscription(Float32,'lwheeld',self.lwheelCallback, 10)
    ...
    def update(self):
        ...
        self.odom_trans.transform.translation.z = self.enc
        self.odom_trans.transform.rotation = euler_to_quaternion(0, 0, self.angle + pi/2) # roll,pitch,ya
